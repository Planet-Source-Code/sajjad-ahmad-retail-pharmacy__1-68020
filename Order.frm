...
'Add Order Head
rs1.Open "Orders", cn, adOpenKeyset, adLockOptimistic
With rs1
    .AddNew
    .Fields(0) = Text1(0)
    .Fields(1) = Text1(1)
...
'Add Order Details
rs2.Open "OrderDetails", cn, adOpenKeyset, adLockOptimistic
With rs2
...
rsINV.Open "Select * from Invoiceqry where BillNo=" & Me.Text1(0), cn, adOpenStatic, adLockOptimistic
...
InvoiceRPT.Sections(2).Controls.Item("label4").Caption = "INVOICE"
...
'InvoiceRPT.Show
InvoiceRPT.Visible = False
InvoiceRPT.PrintReport
